...
import { ProductUpdateComponent } from './componets/product/product-update/product-update.component';
import { ProductDeleteComponent } from './componets/product/product-delete/product-delete.component';
